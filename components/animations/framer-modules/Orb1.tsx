...
export default function Nova(props: NovaProps) {
  const { hue = 0, hoverIntensity = 0.2, rotateOnHover = true } = props;
  ...
  const frag = `
        ...
        vec4 mainImage(vec2 fragCoord, float iTime, float hover, float rot) {
            ...
            return draw(uv, iTime);
        }

        void main() {
            vec2 fragCoord = vUv * iResolution.xy;
            vec4 col = mainImage(fragCoord, iTime, hover, rot);
